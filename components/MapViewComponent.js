...
class MapViewComponent extends Component {
  ...
  render() {
    let destinationLatLng =  {latitude: this.props.destinationLatitude, longitude: this.props.destinationLongitude}
    let originLatLng = { latitude: this.props.originLatitude, longitude: this.props.originLongitude}
